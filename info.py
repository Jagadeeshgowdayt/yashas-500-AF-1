...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/kannada_movie_request_backup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/kannada_movie_request_backup')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001942386281))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'kannada_movie_request_backup')
