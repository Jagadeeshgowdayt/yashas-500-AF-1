...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/all_movie_robot')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/all_movie_robot')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001942386281))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'all_movie_robot')
